...
phonics = {
	a={name="a", length=.65, gain=1, is_silent=0},
	au={name="au", length=.6, gain=1, is_silent=0}, 
	b={name="b", length=.35, gain=1, is_silent=0},	
	c={name="c", length=.65, gain=1, is_silent=0},	
	ch={name="ch", length=.17, gain=1, is_silent=0},
	d={name="d", length=.77, gain=1, is_silent=0},
	...
	l={name="l", length=.65, gain=1, is_silent=0},
	...
	r={name="r", length=.65, gain=1, is_silent=0},
	rr={name="rr", length=.47, gain=1, is_silent=0},	--should use tahoma 16
	s={name="s", length=.65, gain=1, is_silent=0},
	t={name="t", length=.3, gain=1, is_silent=0},	
	u={name="u",length=.65, gain=1, is_silent=1},	-- silent for aqui	
	v={name="v", length=.65, gain=1, is_silent=0},   --sometimes makes makes a sound like a v or halfway between a "v" & a "b"
	w={name="w", length=.45, gain=1, is_silent=0},	
	x={name="x", length=.6, gain=1, is_silent=0},  
	y={name="y", length=.84, gain=1, is_silent=0},			
	z={name="z", length=.65, gain=1, is_silent=0}
}
